            ...
            <List>
              <ListItem disablePadding>
                <ListItemButton>
                  ...
                  <ListItemText
                    primary="Address"
                    secondary={`${value.value.streetAddress}, ${value.value.zipcode}`}
                  />
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton>
                  ...
                  <ListItemText
                    primary="Floors"
                    secondary={`${value.value.bathrooms}`}
                  />
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton>
                  ...
                  <ListItemText
                    primary="Rooms"
                    secondary={`${value.value.bedrooms}`}
                  />
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton>
                  ...
                  <ListItemText
                    primary="Built Area"
                    secondary={`${value.value.lotAreaValue} ${value.value.lotAreaUnit}`}
                  />
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton>
                  ...
                  <ListItemText
                    primary="Cost"
                    secondary={`${value.value.price.toLocaleString()}$`}
                  />
                </ListItemButton>
              </ListItem>
            </List>
